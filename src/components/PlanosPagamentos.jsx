  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Se os créditos do plano terminarem,
          escolha um pacote e a forma de pagamento.
        </p>
        ...
        >
          {[
            ...
            const selecionado =
              pacoteCreditoSelecionado?.quantidade ===
              pacote.quantidade;
          ...
          <>
            ...
            >
              <FormaPagamento
                icone="⚡"
                titulo="Pix"
                texto="Confirmação rápida."
                selecionado={
                  formaPagamentoCreditos ===
                  "pix"
                }
                onClick={() =>
                  setFormaPagamentoCreditos(
                    "pix"
                  )
                }
              />
              ...
              <FormaPagamento
                icone="📄"
                titulo="Boleto"
                texto="Geração de boleto bancário."
                selecionado={
                  formaPagamentoCreditos ===
                  "boleto"
                }
              ...
              <FormaPagamento
                icone="🏦"
                titulo="Transferência"
                texto="Transferência para a conta da empresa."
                selecionado={
                  formaPagamentoCreditos ===
                  "transferencia"
                }
            ...
            {formaPagamentoCreditos ===
              "pix" && (
              <div style={dadosPagamentoBox}>
                <h4 style={dadosPagamentoTitulo}>
                  ⚡ Dados para Pix
                </h4>
                ...
                <div style={qrArea}>
                  <div style={qrPlaceholder}>
                    ...
                    <strong>QR Code Pix</strong>
                    <span style={qrTexto}>
                      Será gerado automaticamente com o
                      valor do pacote selecionado.
                    </span>
                  </div>
                  ...
                  <div style={{ flex: 1, minWidth: "230px" }}>
                    <div style={qrResumo}>
                      <span>Pacote</span>
                      <strong>
                        +{pacoteCreditoSelecionado.quantidade} créditos
                      </strong>
                    </div>
                    ...
                    <div style={qrResumo}>
                      <span>Valor</span>
                      <strong>
                        {pacoteCreditoSelecionado.valor}
                      </strong>
                    </div>
            ...
            {formaPagamentoCreditos ===
              ...
              >
                ...
                >
                  ⚠️ Importante: Os créditos serão adicionados
                  à sua conta após a confirmação do pagamento
                  do boleto.
                </div>
              </div>
            )}
