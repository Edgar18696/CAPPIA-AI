...
import BannerBarraSuperior from "./BannerBarraSuperior";
...
import BannerBiblioteca from "./BannerBiblioteca";
...
import BannerPreviewMarketplace from "./BannerPreviewMarketplace";
import BannerTextoPainel from "./BannerTextoPainel";
import BannerCanvas from "./BannerCanvas";
import BannerProdutoPainel from "./BannerProdutoPainel";
import { criarBannerTextoEngine } from "./BannerTextoEngine";
import { criarBannerImagemEngine } from "./BannerImagemEngine";
...
function adicionarSeloStudio(selo) {
  if (!selo?.texto) {
    return;
  }
    ...
    if (
      ...
      const camadaSelecionada =
        ...
        (imagemSelecionada
          ...
          : textoSelecionadoAtalho
            ? {
                id:
                  textoSelecionadoAtalho.id,
                tipo:
                  textoSelecionadoAtalho.tipo ||
                  "texto",
                nome:
                  textoSelecionadoAtalho.texto ||
                  "Texto",
              }
            : null);
  ...
  />
      ...
      >
        ...
        >
          ...
          {ferramentaStudio === "biblioteca" && (
            <BannerBiblioteca
              onSelecionarFundo={(valor) =>
                setFundoStudio(valor)
              }
              onAdicionarSelo={
                adicionarSeloStudio
              }
              onAdicionarLogo={(logo) => {
                const src =
                  logo?.src ||
                  criarLogoSvg({
                    texto:
...
{ferramentaStudio === "camadas" && (
  <BannerCamadas
    ...
    onAlternarVisibilidade={
      alternarVisibilidadeCamada
    }
    onAlternarBloqueio={
      alternarBloqueioCamada
    }
    onMover={moverCamada}
...
/>
      ...
      <BannerNavigator
        fundoStudio={fundoStudio}
        imagensBanner={imagensBanner}
        textosStudio={textosStudio}
        larguraCanvas={
          larguraPreviewExportacao
        }
        alturaCanvas={
      ...
      <BannerPreviewMarketplace
        aberto={previewMarketplaceAberto}
        canal={canalPreview}
        imagem={previewMarketplaceImagem}
        onFechar={() =>
          setPreviewMarketplaceAberto(
            false
          )
